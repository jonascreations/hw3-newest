...
public:
    ...
    unsigned int wait_time_hold;
    // The hold time of the process
    unsigned int burst_time_hold;
    // The hold time of the process
    unsigned int throughput_hold;
    ...
    PCB(string name, unsigned int id = 0, unsigned int priority = 1, unsigned int burst_time = 0) {
        ...
        this->arrival_time = 0;
        this->wait_time_hold = 0;
        this->burst_time_hold = burst_time;
        this->throughput_hold = 0;
    }
    ...
    void print_wait_throughput() {
        cout <<  name << " turn-around time = " << throughput_hold << ", waiting time = " << wait_time_hold << endl;
    }
};
