...
private:
	std::vector<PCB>* process_list_hold = 0;
...
public:
    ...
    void get_avgs();
    int find_next_shortest();//gets the next shortest process
    int no_burst_time();//tells whether vector has no more bursts to do
};
